...
var $author$project$PhotoGroove$initialModel = function (_v0) {
	return _Utils_Tuple2(
		{chosenSize: $author$project$PhotoGroove$Medium, status: $author$project$PhotoGroove$Loading},
...
var $author$project$PhotoGroove$main = $elm$browser$Browser$element(
	{
		init: $author$project$PhotoGroove$initialModel,
...
_Platform_export({'PhotoGroove':{'init':$author$project$PhotoGroove$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"PhotoGroove.Msg","aliases":{"PhotoGroove.Photo":{"args":[],"type":"{ url : String.String }"}},"unions":{"PhotoGroove.Msg":{"args":[],"tags":{"ClickedPhoto":["String.String"],"ClickedSize":["PhotoGroove.ThumbnailSize"],"ClickedSupriseMe":[],"GotRandomPhoto":["PhotoGroove.Photo"],"GotPhotos":["Result.Result Http.Error String.String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"PhotoGroove.ThumbnailSize":{"args":[],"tags":{"Small":[],"Medium":[],"Large":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}}}}})}});}(this));